...
void Update(GameData* data, float dt){
	...
	else if(KeyPressed(&data->input, SDL_SCANCODE_LEFT) || KeyHeld_ForTime(&data->input, SDL_SCANCODE_LEFT, (1 / MOVE_SPEED) * 1.5)){
...
void Draw(GameData* data, SDL_Renderer* renderer){
	...
	SDL_SetRenderDrawColor(renderer, 108, 177, 178, 255);
